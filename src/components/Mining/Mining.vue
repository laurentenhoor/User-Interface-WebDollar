    ...
    <div id="dashboardMining" class="walletSection">
        ...
        <div id="minningController">
            ...
            <div class="miningDetails" v-on:click="toggleMiningInfo()">
                ...
                -->
                <p class="rocketManContainer">
                 <svg :style="{display: this.started==true  ? 'inline-block' : 'none'}" class="rocketManSVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"viewBox="0 0 600 600" >
                    <defs>
